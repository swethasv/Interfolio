...
public class PacketAttachment {
	 ...
	 // private String host = "https://rpt-sandbox.interfolio.com";
	  ...
	  private String request_string ="/byc-tenure/"+ tenant_id +"/packets/30095/packet_attachments";
	...
	//Faculty180 API will not accept the query string as a part of the request verb, but BYC requires it.
	  ...
	  private String getResults() throws IOException {
		    ...
		    try (OutputStream os = conn.getOutputStream()) {
		    	String jsonString = "{\"packet_attachment\":{\"display_name\":\"testFileName\"},\"packet_section_id\":203530}";
	  ...
	  public static void main(String[] args) {
	    PacketAttachment token = new PacketAttachment();
	    try {
